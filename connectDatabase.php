...
function CreateDatabaseTableUsers($data)
{
  ...
  try {
    $dummy_data = [
      [1, "usuario1", "login1", "senha1", "usuario1"],
      [2, "usuario2", "login2", "senha2", "usuario2"],
      [3, "usuario3", "login3", "senha3", "usuario3"],
      [4, "usuario4", "login4", "senha4", "usuario4"],
      [5, "usuario5", "login5", "senha5", "usuario5"],
      [6, "usuario6", "login6", "senha6", "usuario6"],
      [7, "usuario7", "login7", "senha7", "usuario7"],
      [8, "usuario8", "login8", "senha8", "usuario8"],
      [9, "usuario9", "login9", "senha9", "usuario9"],
      [10, "usuario10", "login10", "senha10", "usuario10"],
      [11, "usuario11", "login11", "senha11", "usuario11"],
      [12, "usuario12", "login12", "senha12", "usuario12"],
      [13, "usuario13", "login13", "senha13", "usuario13"],
      [14, "usuario14", "login14", "senha14", "usuario14"],
      [15, "usuario15", "login15", "senha15", "usuario15"],
      [16, "usuario16", "login16", "senha16", "usuario16"]
    ];
    ...
    $insert = $pdo_connection->prepare("INSERT INTO usuarios (id, nome, login, senha) VALUES (?,?,?,?) ON DUPLICATE KEY UPDATE nome=(?)");
